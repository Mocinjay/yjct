...
const SPLASH = require('./assets/clypso-splash.mp4');
...
/**
 * Launch splash: the CLYPSO logo animation plays centered on black, then the
 * screen yields to the app.
 */
export function ClypsoSplash({ onFinished }: Props) {
